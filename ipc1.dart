...
import 'ipc1_model.dart';
export 'ipc1_model.dart';

class Ipc1Widget extends StatefulWidget {
  const Ipc1Widget({super.key});

  @override
  State<Ipc1Widget> createState() => _Ipc1WidgetState();
}

class _Ipc1WidgetState extends State<Ipc1Widget> with TickerProviderStateMixin {
  late Ipc1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Ipc1Model());
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: Text(
                                                      'Deals with the prohibition of the adult male person from aiding or abetting or committing any act of domestic violence, entering the place of aggrieved person or aggrieved child, attempting to communicate with aggrieved person, alienating any asset, causing violence to dependents, other relatives or any other person who give the aggrieved person assistance from domestic violence and committing any other act as specified in the protection order.',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      '                                   MONETARY ORDERS WHICH INCLUDES MAINTENANCE FOR HERSELF AND HER CHILDREN',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium
